...
export default function AllProjectsPage() {
  ...
  let [selectedProject, setSelectedProject] = useState("All Projects");
  ...
  let filteredProjects = searchProjects.filter((project) => {
    ...
    return selectedProject === project.projectName;
  });
          ...
          <table className="mt-5 text-left py-5 text-sm">
            ...
            <tbody>
              {sortedAndFilteredProjects.map((project) => (
                <tr
                  key={project.id}
                  className="bg-white border-t-10 border-gray-100"
                >
