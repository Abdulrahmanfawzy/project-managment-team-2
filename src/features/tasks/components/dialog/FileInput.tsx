    ...
    return (
        <div className="flex items-center justify-center w-full">
            <div className="w-full text-gray-500">
                <p className="mr-auto text-sm font-medium mb-2">Add Task Files</p>

                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-30 bg-neutral-secondary-medium border border-dashed border-default-strong rounded-2xl cursor-pointer hover:bg-neutral-tertiary-medium">
